 ...
 * Fetches product data from DummyJSON using the dynamic route ID.
 * Includes product specs, image gallery, customer reviews, and an Add to Cart feature.
 */
...
export default function ProductDetailPage() {
  ...
  // Add product to cart and show feedback for 2 seconds
  const handleAdd = () => {
    addToCart(product);
    setAdded(true);
  ...
  // Format the product release date
